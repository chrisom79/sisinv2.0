...
<div id="wrapper">
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
       ...
       <div class="navbar-header">
           ...
           <a class="navbar-brand" href="home.jsp">Waay - Abarrotes Hermanos Cervantes</a>
       </div>
       <!-- Top Menu Items -->
       <ul class="nav navbar-right top-nav">
           <li class="dropdown">
               ...
               <ul class="dropdown-menu">
                   ...
                   <li>
                       <a href="settings.jsp"><i class="fa fa-fw fa-gear"></i> Ajustes</a>
                   </li>
                   <li class="divider"></li>
                   <li>
                       <a onclick="logout()" href="login.jsp"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                   </li>
               </ul>
           </li>
       </ul>
