	 	 	...
	 	 	<!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-24">
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-plus-square"></i>  Crear oferta
                            </li>
                        </ol>
                    </div>
                </div>
             <!-- row -->
             <form id="form-prod" role="form" action="OfertaAction" method="POST">
	            ...
	            <button type="submit" class="btn btn-primary" onclick='save()'>Crear</button>
	         </form>
          </div>
		</div>
	</div>
